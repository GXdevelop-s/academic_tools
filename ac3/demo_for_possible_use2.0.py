...
manufacturing_industries_expanded = [
    '农副食品加工业(有限责任公司)', '农副食品加工业(个体工商户)',
    '食品制造业(有限责任公司)', '食品制造业(个体工商户)',
    '酒、饮料和精制茶制造业(有限责任公司)', '酒、饮料和精制茶制造业(个体工商户)',
    '烟草制品业(有限责任公司)', '烟草制品业(个体工商户)',
    '纺织业(有限责任公司)', '纺织业(个体工商户)',
    '纺织服装、服饰业(有限责任公司)', '纺织服装、服饰业(个体工商户)',
    '皮革、毛皮、羽毛及其制品和制鞋业(有限责任公司)', '皮革、毛皮、羽毛及其制品和制鞋业(个体工商户)',
    '木材加工和木、竹、藤、棕、草制品业(有限责任公司)', '木材加工和木、竹、藤、棕、草制品业(个体工商户)',
    '家具制造业(有限责任公司)', '家具制造业(个体工商户)',
    '造纸和纸制品业(有限责任公司)', '造纸和纸制品业(个体工商户)',
    '印刷和记录媒介复制业(有限责任公司)', '印刷和记录媒介复制业(个体工商户)',
    '文教、工美、体育和娱乐用品制造业(有限责任公司)', '文教、工美、体育和娱乐用品制造业(个体工商户)',
    '石油、煤炭及其他燃料加工业(有限责任公司)', '石油、煤炭及其他燃料加工业(个体工商户)',
    '化学原料和化学制品制造业(有限责任公司)', '化学原料和化学制品制造业(个体工商户)',
    '医药制造业(有限责任公司)', '医药制造业(个体工商户)',
    '化学纤维制造业(有限责任公司)', '化学纤维制造业(个体工商户)',
    '橡胶和塑料制品业(有限责任公司)', '橡胶和塑料制品业(个体工商户)',
    '非金属矿物制品业(有限责任公司)', '非金属矿物制品业(个体工商户)',
    '黑色金属冶炼和压延加工业(有限责任公司)', '黑色金属冶炼和压延加工业(个体工商户)',
    '有色金属冶炼和压延加工业(有限责任公司)', '有色金属冶炼和压延加工业(个体工商户)',
    '金属制品业(有限责任公司)', '金属制品业(个体工商户)',
    '通用设备制造业(有限责任公司)', '通用设备制造业(个体工商户)',
    '专用设备制造业(有限责任公司)', '专用设备制造业(个体工商户)',
    '汽车制造业(有限责任公司)', '汽车制造业(个体工商户)',
    '铁路、船舶、航空航天和其他运输设备制造业(有限责任公司)', '铁路、船舶、航空航天和其他运输设备制造业(个体工商户)',
    '电气机械和器材制造业(有限责任公司)', '电气机械和器材制造业(个体工商户)',
    '计算机、通信和其他电子设备制造业(有限责任公司)', '计算机、通信和其他电子设备制造业(个体工商户)',
    '仪器仪表制造业(有限责任公司)', '仪器仪表制造业(个体工商户)',
    '其他制造业(有限责任公司)', '其他制造业(个体工商户)',
    '废弃资源综合利用业(有限责任公司)', '废弃资源综合利用业(个体工商户)',
    '金属制品、机械和设备修理业(有限责任公司)', '金属制品、机械和设备修理业(个体工商户)'
]
...
# 存储到excel中
def save_as_excel():
    with pd.ExcelWriter('final_result2.0.xlsx', engine='openpyxl') as writer:
        startrow = 0
...
if __name__ == '__main__':
    ...
    last_city = ''
    city_list = []  # 所有城市对象的容器
    directory_path = r'D:\中国工商注册企业全量信息（2023.9更新）\全国数据'
